...
Automated Email Alerts: Sends real-time GPS coordinates to trusted contacts via a Node.js backend.
...
Stealth Utilities: Includes a "Fake Incoming Call" simulator and a high-frequency acoustic alarm.
...
Run node server.js to start the local environment.